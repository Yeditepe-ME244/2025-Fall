...
\[ \sum_i \boldsymbol{M}_i^O = \boldsymbol{r} \times \sum_i \boldsymbol{F}_i \]
...
\[ \sum_i \boldsymbol{M}_i^O = \dot{\boldsymbol{H}^O} \]
...
\[ \sum_i \boldsymbol{M}_i^O dt = d \boldsymbol{H}^O \]
...
- we can write one angular equation of motion out of plane ($z$)
  \[  (H_z^O)_1 + \int_{t_1}^{t_2} \sum_i M_iz^O dt = (H_z^O)_2 \]
...
[[./meriam/prob_3.220.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.225.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.226.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.227.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.228.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.230.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.235.png]]

#+REVEAL: split
#+ATTR_HTML: :width 700px
[[./meriam/prob_3.236.png]]
